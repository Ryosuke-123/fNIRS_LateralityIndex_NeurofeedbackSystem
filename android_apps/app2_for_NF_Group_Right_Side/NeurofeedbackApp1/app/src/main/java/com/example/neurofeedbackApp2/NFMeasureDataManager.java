...
public class NFMeasureDataManager
{
    ...
    // NFシステム 計測データ ストア開始
    public boolean startStoreNFMeasureData(boolean should_output_log, String folderName, String address, String restTime, String baselineTime, String movingAvgTime, String trainingTime)
    {
        ...
        if (mMeasureLogEnabled)
        {
            ...
            boolean result  = mNFMeasureDataLogger.open(fileName,folderName,mAddress,restTime,baselineTime,movingAvgTime,trainingTime);
